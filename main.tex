		...
		\subsection{Testing con gli utenti}
			...
			\begin{frame}
				...
				\begin{itemize}[<+->]
					...
					\item \textbf{4}: \`E lasciato all'utente il compito di calcolare il tasso di letalità\\
					\item \textbf{7}: \`E lasciato all'utente il compito di calcolare gli incrementi in un periodo di tempo\\
					\item \textbf{2}: Alcuni dati sono presenti nel PDF raggiungibile tramite il link ``Schede riepilogo PDF''\\
				\end{itemize}
			\end{frame}

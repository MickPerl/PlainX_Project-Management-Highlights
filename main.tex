...
\begin{document}
	...
	\section{Progettazione proposta}
		...
		\begin{frame}
			...
			La realizzazione dei bluprint ha avuto necessità di tre iterazione che ci hanno portato a produrre un blueprint per comprendere quali contenuti devono esserci all'interno di ogni pagina e un blueprint per i programmatori che indichi quali componenti sono presenti all'interno di ogni pagina.
		\end{frame}
